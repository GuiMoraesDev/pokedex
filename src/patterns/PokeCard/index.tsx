...
export default function PokeCard({ index, ...props }: Props) {
  return (
    <Link
      ...
      className="will-change-all container h-64 relative flex flex-col items-center justify-evenly gap-2 overflow-hidden rounded-md border-2 border-blue-600 bg-red-400 p-6 text-xl transition-all duration-200 focus:scale-105 focus:bg-red-400 focus:outline-none focus:ring focus:ring-blue-400 hover:scale-105 hover:border-blue-600 hover:bg-red-400"
    >
